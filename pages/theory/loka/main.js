...
function updateComparisonUI() {
    ...
    document.getElementById('loka-ops').textContent = String(state.operations);
    document.getElementById('trad-boundaries').textContent = '2';
    document.getElementById('loka-boundaries').textContent = '0';
}
function resetState() {
    ...
    document.getElementById('loka-ops').textContent = '—';
