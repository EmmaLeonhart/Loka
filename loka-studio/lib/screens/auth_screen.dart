...
///
/// Loka authentication is not yet implemented on the server side
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor:
              conn.connected ? LokaTheme.green : LokaTheme.orange,
        ),
      );
    }
  }
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: LokaTheme.orange.withOpacity(0.1),
                  border: Border.all(
                      color: LokaTheme.orange.withOpacity(0.3)),
                  borderRadius: BorderRadius.circular(6),
                ),
                child: const Row(
                  children: [
                    Icon(Icons.info_outline,
                        color: LokaTheme.orange, size: 16),
                    SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        'Authentication is not yet implemented on the Loka server. '
