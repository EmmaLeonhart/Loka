...
import '../services/loka_client.dart';
...
class _HealthScreenState extends State<HealthScreen> {
          ...
          Row(
            children: [
              const Icon(Icons.monitor_heart_outlined,
                  color: LokaTheme.accent, size: 24),
        ...
        child: Row(
          children: [
            Icon(
              Icons.circle,
              size: 12,
              color: conn.connected ? LokaTheme.green : LokaTheme.red,
            ),
            const SizedBox(width: 10),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(
                      color: LokaTheme.muted, fontSize: 12),
                ),
              ],
            ),
          ],
    ...
    return _card(
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.grain, size: 18, color: LokaTheme.purple),
              SizedBox(width: 8),
          ...
          if (_vectorHealth.isEmpty)
            const Text(
              ...
              style: TextStyle(color: LokaTheme.muted, fontSize: 12),
            )
          else
            ..._vectorHealth.map((v) => _buildVectorHealthRow(v)),

          const SizedBox(height: 16),
          const Divider(color: LokaTheme.border),
  ...
  Widget _buildVectorHealthRow(_VectorPredicateHealth v) {
    ...
    if (v.needsCompaction) {
      healthColor = LokaTheme.red;
      healthLabel = 'NEEDS COMPACTION';
    } else if (v.deletedRatio > 0.15) {
      healthColor = LokaTheme.orange;
      healthLabel = 'Warning';
    } else {
      healthColor = LokaTheme.green;
      healthLabel = 'Healthy';
    }
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    backgroundColor: LokaTheme.border,
    ...
    return _card(
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.grid_on, size: 18, color: LokaTheme.orange),
              SizedBox(width: 8),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('${v.dimensions}d ${v.metric}',
                      style: const TextStyle(fontSize: 10, color: LokaTheme.muted)),
                ],
              ),
            );
          }),
    ...
    return _card(
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.backup, size: 18, color: LokaTheme.accent),
              SizedBox(width: 8),
          ...
          Row(
            children: [
              ElevatedButton.icon(
                onPressed: () async {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Manual backup: use CLI "loka serve --backup-interval 1" for one-time backup'),
                    ),
                  );
                },
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: LokaTheme.accent,
              ...
              ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: LokaTheme.surface,
                  foregroundColor: LokaTheme.text,
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                ),
              ),
            ],
    ...
    return _card(
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.construction, size: 18, color: LokaTheme.orange),
              SizedBox(width: 8),
  ...
  Widget _healthIndicator(String title, String description, IconData icon) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(icon, size: 14, color: LokaTheme.muted),
          const SizedBox(width: 8),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _plannedItem(String title, String desc) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Icon(Icons.schedule, size: 12, color: LokaTheme.muted),
          const SizedBox(width: 8),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _statCard(String label, String value, IconData icon, Color color) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: LokaTheme.border),
  ...
  Widget _errorCard(String msg) {
    return _card(
      child: Row(
        children: [
          const Icon(Icons.error_outline, color: LokaTheme.red),
          const SizedBox(width: 8),
          Expanded(
              child: Text(msg,
                  style: const TextStyle(color: LokaTheme.red))),
        ],
      ),
    );
  }
