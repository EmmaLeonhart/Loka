      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: LokaTheme.green,
          ),
        );
        _load();
      }
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              const Icon(Icons.table_rows, size: 18, color: LokaTheme.accent),
              const SizedBox(width: 8),
              const Text('Triples',
                  style: TextStyle(
  ...
  Widget _objectCell(Triple t) {
    if (t.isVector) {
      return Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.grain, size: 12, color: LokaTheme.purple),
