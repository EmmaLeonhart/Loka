...
/// interact with Loka via AI agents or application code. This
  ...
  static const _templates = {
    ...
    'Vector search':
        'SELECT ?doc WHERE {\n  VECTOR_SIMILAR(?doc <http://example.org/hasEmbedding>\n'
            '    "0.1 0.2 0.3"^^<loka:f32vec>, 0.85)\n}',
    'HNSW neighbors':
        'SELECT ?src ?tgt WHERE {\n  ?src <loka:hnswNeighbor> ?tgt\n} LIMIT 50',
    'Star annotations':
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              const Icon(Icons.code, size: 18, color: LokaTheme.accent),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    border:
                        Border(right: BorderSide(color: LokaTheme.border)),
                  ),
                  child: TextField(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.error_outline,
                  color: LokaTheme.red, size: 32),
              const SizedBox(height: 8),
              SelectableText(
                _error!,
                style: const TextStyle(color: LokaTheme.red, fontSize: 12),
              ),
            ],
          ),
        ),
    ...
    if (_result == null) {
      return const Center(
        child: Text(
          ...
          style: TextStyle(color: LokaTheme.muted, fontSize: 13),
        ),
      );
    }
