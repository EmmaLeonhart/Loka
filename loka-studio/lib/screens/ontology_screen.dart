...
/// ontology editing, use the Loka Protege plugin (tools/protege-plugin/).
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              const Icon(Icons.account_tree, size: 18, color: LokaTheme.accent),
              ...
              const Spacer(),
              const Text(
                'For full ontology editing, use Protege with the Loka plugin',
                style: TextStyle(color: LokaTheme.muted, fontSize: 11),
              ),
              ...
              children: _classes.map((c) {
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    color: isSelected
                        ? LokaTheme.accent.withOpacity(0.1)
                        : null,
                    child: Row(
                      children: [
                        Icon(
    ...
    if (_selectedClass == null) {
      return const Center(
        child: Text('Select a class to view details',
            style: TextStyle(color: LokaTheme.muted)),
      );
    }
          ...
          if (c.parentIri != null) ...[
            ...
            Text.rich(TextSpan(children: [
              ...
              TextSpan(
                  ...
                  style: const TextStyle(
                      color: LokaTheme.orange, fontSize: 12)),
            ])),
          ],
                    ...
                    children: [
                      ...
                      if (p.range.isNotEmpty) ...[
                        ...
                        Text(_shortName(p.range),
                            style: const TextStyle(
                                color: LokaTheme.green, fontSize: 12)),
                      ],
                    ],
                  ),
                )),
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.diamond_outlined,
                              size: 12, color: LokaTheme.purple),
                          const SizedBox(width: 6),
                          Expanded(
                            child: Tooltip(
